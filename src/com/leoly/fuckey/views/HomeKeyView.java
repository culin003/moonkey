...
public class HomeKeyView extends KeyViewAdaptor {

	public HomeKeyView(Context context) {
		super(context);
		setOnLongClickListener(null);
		setOnClickListener(null);
		setImageBitmap(SharePool.get(Cs.HOME_KEY, Bitmap.class));
		setName("主页键");
	}

	public HomeKeyView(Context context, AttributeSet atrs) {
		super(context, atrs);
		setOnLongClickListener(null);
		setOnClickListener(null);
		setImageBitmap(SharePool.get(Cs.HOME_KEY, Bitmap.class));
	...
	public HomeKeyView(Context context, AttributeSet atrs, int defStyle) {
